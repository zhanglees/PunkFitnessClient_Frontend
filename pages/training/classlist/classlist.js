...
Page({
    ...
    /***查看该阶段课程列表 */
    gotoDetail(e) {
        const { index, trainingPlanId, userTrainitemId } = e.currentTarget.dataset;
