...
Page({
    ...
    gotoDetail(e){
        ...
        const url = (this.data.type == 'plan' ? ('/pages/packageA/training/stagedetail/stagedetail?trainingPlanId='  + trainingPlanId + '&userId=' + this.data.userId + '&userTrainitemId=' + userTrainitemId) : '/pages/packageA/training/class/class?trainingPlanId=');
