...
Page({
    ...
    onLoad: function(options) {
        const { userTrainitemId, trainingPlanId, classId, className, coachId, coachName, classIndex } = options;
    ...
    getClasses(userTrainitemId, trainingPlanId, classId, userId, coachId, coachName) {
